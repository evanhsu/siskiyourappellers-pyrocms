...
--
-- Host: localhost    Database: siskiyourappellers
-- ------------------------------------------------------
...
--
-- Current Database: `siskiyourappellers`
--

-- CREATE DATABASE /*!32312 IF NOT EXISTS*/ `siskiyourappellers` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
INSERT INTO `src_posts_types` VALUES (1,1,'2016-11-22 20:17:05',NULL,NULL,NULL,NULL,'default','{{ post.content.render|raw }}','theme::layouts/default.twig'),(2,2,'2016-12-07 08:53:01',1,NULL,NULL,'2017-01-13 00:21:48','link','{{ post.content|raw }}','theme::layouts.blog');
...
INSERT INTO `src_variables_contact` VALUES (1,1,'2017-01-21 04:51:29',1,NULL,NULL,'657 Flaming Rd.\r\nGrants Pass, OR 97526','541-471-6891','541-471-6887');
...
-- Dump completed on 2017-01-21 17:45:43
